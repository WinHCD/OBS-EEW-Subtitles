...
const CONFIG={
    ...
    // 应用信息文本
    APP_INFO:"所有地震预警信息均为公开信息，最终结果请以当地官方正式测定结果为准。直播间基本无人值守。地震不可准确预测，不要盼震盼灾，请理性讨论。 应用信息【左上：TREM Lite；左下：要石；右上：EQuake；右下：GlobalQuake（根据台站信息自动测算，精度有限）】所有应用均可自行下载。"
};
